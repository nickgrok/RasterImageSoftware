...
public class Puzzle {
    ...
    public Puzzle() {
        ...
        // fields that you add.
        this.complete = new boolean[DIM][DIM];
     ...
     *    18 ...
     *
     *  I had some difficulty implementing this method.  I managed to solve the larger issues I was having, but
     *  there are still some values that are remaining empty after the method backtracks
     *  I believe this is caused by the last line of recursion, but as it is now approaching 8PM I am not able to
     *  continue working on it.  If it isn't too much trouble would you please let me know where I went wrong
     *  here?  Thanks. 
     */
     private boolean solveRB(int n) 
    {
        ...
        for(int i=1; i<=DIM; i++)
        {
            if((checkRow(i, n/DIM)) && (checkCol(i, n%DIM)) && (!subgridHasValue[(n/DIM)/SUBGRID_DIM][(n%DIM)/SUBGRID_DIM][i]))
            {
                ...
                //count2++;
                //System.out.println("removed " + i + " at " + n/DIM + "," + n%DIM + " " + count2);
